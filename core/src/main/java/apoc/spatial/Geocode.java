...
public class Geocode {
    ...
    private static class NominatimSupplier implements GeocodeSupplier {
        ...
        public NominatimSupplier(Configuration config, TerminationGuard terminationGuard, String provider) {
            this.configBase = provider;
    ...
    public static GeocodeSupplier getGeocodeSupplier(
        ...
        return switch (supplier) {
            ...
            case "nominatim" -> new NominatimSupplier(activeConfig, terminationGuard, supplier);
