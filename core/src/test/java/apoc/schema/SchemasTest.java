...
public class SchemasTest {
    ...
    public void testUniquenessConstraintOnNode() {
        ...
        testResult(db, "CALL apoc.schema.nodes() " +
                "YIELD label, properties, name, userDescription, type, status " +
                "RETURN * ORDER BY type", (result) -> {
            Map<String, Object> r = result.next();
    ...
    public void testIndexAndUniquenessConstraintOnNode() {
        ...
        testResult(db, "CALL apoc.schema.nodes() " +
                ...
                "RETURN * ORDER BY label, type", (result) -> {
            Map<String, Object> r = result.next();

            assertionBarUniqueCons(r);
    ...
    private static void assertionBarUniqueCons(Map<String, Object> r) {
        assertEquals("Bar", r.get("label"));
