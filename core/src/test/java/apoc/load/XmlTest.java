...
public class XmlTest {
    ...
    public void testLoadXmlFromTarByUrl() {
        // todo - change with https://github.com/neo4j/apoc/blob/issue_11/core/src/test/resources/testload.gz?raw=true
        testResult(db, "call apoc.load.xml('https://github.com/vga91/apoc/blob/issue_11/core/src/test/resources/testload.tar?raw=true!xml/books.xml') yield value as catalog\n" +
                "UNWIND catalog._children as book\n" +
                "RETURN book.id as id\n", result -> {
            List<Object> ids = Iterators.asList(result.columnAs("id"));
            assertTrue(IntStream.rangeClosed(1,12).allMatch(value -> ids.contains(String.format("bk1%02d",value))));
    ...
    public void testLoadXmlFromTarGzByUrl() {
        // todo - change with https://github.com/neo4j/apoc/blob/issue_11/core/src/test/resources/testload.gz?raw=true
        testResult(db, "call apoc.load.xml('https://github.com/vga91/apoc/blob/issue_11/core/src/test/resources/testload.tar.gz?raw=true!xml/books.xml') yield value as catalog\n" +
                "UNWIND catalog._children as book\n" +
                "RETURN book.id as id\n", result -> {
            List<Object> ids = Iterators.asList(result.columnAs("id"));
            assertTrue(IntStream.rangeClosed(1,12).allMatch(value -> ids.contains(String.format("bk1%02d",value))));
    ...
    public void testLoadXmlFromTgzByUrl() {
        // todo - change with https://github.com/neo4j/apoc/blob/issue_11/core/src/test/resources/testload.tgz?raw=true
        testResult(db, "call apoc.load.xml('https://github.com/vga91/apoc/blob/issue_11/core/src/test/resources/testload.tgz?raw=true!xml/books.xml') yield value as catalog\n" +
                "UNWIND catalog._children as book\n" +
                "RETURN book.id as id\n", result -> {
            List<Object> ids = Iterators.asList(result.columnAs("id"));
            assertTrue(IntStream.rangeClosed(1,12).allMatch(value -> ids.contains(String.format("bk1%02d",value))));
