...
public class GeocodeTest {
    ...
    private static final String BLOCKED_ERROR = "access to /" + BLOCKED_ADDRESS
            + " is blocked via the configuration property internal.dbms.cypher_ip_blocklist";
...
//        apocConfig().setProperty(Geocode.PREFIX + ".nominatim" + ".reverse.url", "https://svilgeocoding.utenze.bankit.it/nominatim/reverse.php?format=json&lat=LAT&lon=LNG&key=KEY");
    ...
    private void assertGeocodeFails(boolean reverseGeocode, String expectedMsgError, String url, String reverseUrl) {
        ...
        Map<String, Object> conf =
                url == null ? Collections.emptyMap() : Map.of("key", "myOwnKey", "url", url, "reverseUrl", reverseUrl);
